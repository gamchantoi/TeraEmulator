...
namespace Tera.ActionEngine
{
    class GuildAction : IRequestAction
    {
        ...
        private void PartyFinished()
        {
            ...
            {
                int pendingRequests = _owner.Party.PartyMembers.Count(member => member != _owner && member.GuildAccepted == 0);
