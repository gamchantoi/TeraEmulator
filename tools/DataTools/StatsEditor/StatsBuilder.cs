...
namespace DataTools.StatsEditor
{
    class StatsBuilder
    {
        public static string BinPath = Path.GetFullPath("../../../../Tera/bin/Debug/data/stats.bin");
        ...
        private static void AppendNpcStats(List<CreatureBaseStats> stats)
        {
            ...
            File.Copy(Path.GetFullPath("../../../../Tera/bin/Debug/data/npc_templates.bin"), "data/items.bin");
            ...
            File.Copy(Path.GetFullPath("../../../../Tera/bin/Debug/data/npc_templates.bin"), "data/npc_templates.bin");
